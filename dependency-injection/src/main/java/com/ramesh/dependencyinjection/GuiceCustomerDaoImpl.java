...
/**
 * 
 * CustomerDaoImpl implements inversion of control. It depends on abstraction(DataSource interface) that can be injected
 * through its constructor.
 *
 */
public class GuiceCustomerDaoImpl implements CustomerDao {

	
	private DataSource dataSource;

	@Inject
	public GuiceCustomerDaoImpl(DataSource dataSource) {
